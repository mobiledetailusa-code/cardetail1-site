...
(function () {
  ...
  var BOOKING_FAIL_MSG = 'We could not load this booking option. Please try again or call/text (551) 389-3986.';
  var overlay = null;
  var frame = null;
  ...
  function showBookingError(msg, code, categoryId, packageId) {
    ...
    el.innerHTML = (msg || BOOKING_FAIL_MSG) +
      ' <a href="tel:+15513893986" style="color:#4da3ff;font-weight:600;text-decoration:none">Call / Text</a>';
    el.hidden = false;
