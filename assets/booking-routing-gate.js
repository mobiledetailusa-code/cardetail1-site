...
(function (global) {
  ...
  function showRoutingPanel(route, kind) {
    ...
    panel.innerHTML = [
      ...
      ctaLabel, '</button>',
      '<a href="tel:+15513893986" style="padding:10px 14px;border-radius:999px;border:1px solid rgba(77,163,255,.45);color:#4da3ff;text-decoration:none;font-weight:600">Call / Text</a>',
      '</div>',
    ].join('');
