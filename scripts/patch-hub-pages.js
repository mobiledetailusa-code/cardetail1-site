...
const oldOnBkZip = `function onBkZipInput(val){
  ...
  if(svc){
    ...
    if(gateMsg){ gateMsg.classList.remove('unlocked'); gateMsg.innerHTML='<span class="zg-ico">⚠️</span><span>Outside our '+TRAVEL_MAX_MILES+'-mile area — call (551) 389-3986</span>'; }
  }
  updateTotal();
}`;
