...
const CARS_ADDONS = `    addons:[
      ...
      {id:'seasonal_driveway_cleanup', scope:'any', name:'Driveway & Entry Cleanup', desc:'Driveway, front walkway/steps and immediate entry area. Light leaves and loose debris cleared with professional blowing equipment.', price:95},
...
const POWERSPORTS_ADDONS = `    addons:[
      ...
      {id:'seasonal_driveway_cleanup', name:'Driveway & Entry Cleanup', desc:'Driveway, front walkway/steps and immediate entry area. Light leaves and loose debris cleared with professional blowing equipment.', price:95, publicNew:true},
