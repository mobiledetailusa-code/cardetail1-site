...
const PACKAGES = [
  {
    ...
    price: 200,
    note: 'Sedans from $200 · SUVs from $220 · trucks from $245',
    time: '~1.5–2 hrs',
  },
  {
    id: 'full',
    ...
    price: 250,
    note: 'Sedans from $250 · SUVs from $270 · 3-row from $280',
    time: '~2.5–3 hrs',
    popular: true,
  },
  {
...
const CITIES = [
  {
    ...
    description:
      'Mobile car detailing in Palisades Park, NJ — our home base. Interior from $200, full detail from $250 at your driveway. We bring water and power. Book online.',
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Mobile appointments run Monday–Friday, 8AM–5PM, by appointment. Call or text (551) 389-3986 if you need to check a specific day.',
      },
    ],
    paragraphs: [
      'Cardetail1 is based in Palisades Park, ZIP 07650 — not a shop you drop the car at. We load water, power, and professional chemicals in the van and detail in your driveway, parking pad, or an approved lot. Palisades Park is the shortest hop on our Bergen County route, so standard interior, full, and exterior packages here use the same core NJ pricing you see on the homepage: Interior Detail from $200 Premium Full Detail from $250 for sedans, and Exterior Detail & Paint Enhancement from $335.',
      ...
      'Booking uses the same homepage form: ZIP 07650 unlocks car packages, then vehicle size. Add-ons such as pet hair ($95), odor treatment ($90), engine-bay top clean ($45), and headlight restoration ($90) only apply if you select them. No charge is collected when you submit. We review access and contact you about the day (Monday–Friday, 8AM–5PM). Call (551) 389-3986. Neighboring towns from this base include Fort Lee, Edgewater, Englewood, Teaneck, and Hackensack — use those pages if the car sits there instead.',
    ],
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Yes. Exterior Detail & Paint Enhancement (from $370) and Premium Full Detail both include exterior decontamination. Commuter film on light-colored paint is a common Fort Lee request.',
      },
      {
    ...
    paragraphs: [
      ...
      'Enter ZIP 07024 to load pricing, submit the request, and wait for confirmation — no charge at request. Hours Monday–Friday 8AM–5PM. Call (551) 389-3986 if the building needs a certificate of insurance before we are allowed in. Nearby pages: Palisades Park, Edgewater, Englewood, Teaneck.',
    ],
  },
  {
    ...
    description:
      'Mobile car detailing in Paramus, NJ (07652). Interior from $200, full detail from $250 at your driveway. Bergen County core route from Palisades Park. Book online.',
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Premium Full Detail is the most booked inside-and-out package (SUVs from $300, 3-row from $310). Interior-only starts at $245 for two-row SUVs. Exterior Detail from $370 if the paint and wheels are the issue.',
      },
      {
    ...
    paragraphs: [
      'Paramus (07652 / 07653) is a Bergen County driveway stop on our Palisades Park route — larger suburban lots than the Gold Coast, which usually means easier staging for a full interior or exterior job. We still bring our own water and power. Pricing matches the homepage catalog: Interior Detail from $200 (sedan), Premium Full Detail from $275 / $300 / $310 by size, Exterior Detail & Paint Enhancement from $335.',
      ...
      'Enter ZIP 07652 or 07653 so the quote matches the house, not a neighboring town. Call (551) 389-3986. Nearby dedicated pages: Ridgewood, Hackensack, Teaneck, Palisades Park. Bergen County hub covers Glen Rock, Fair Lawn, and Saddle Brook without their own landing pages yet.',
    ],
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Interior Detail starts at $220 for sedans, $245 for two-row SUVs, and $270 for trucks. Final price follows vehicle size, condition, and add-ons after you enter ZIP 07601.',
      },
      {
    ...
    paragraphs: [
      ...
      'Call (551) 389-3986. Nearby pages: Teaneck, Paramus, Palisades Park, Englewood, Ridgewood. Quotes on this page are copied from the public Google listing, not invented testimonials.',
    ],
  },
  {
    ...
    description:
      'Mobile car detailing in Englewood, NJ (07631). Driveway interior, full, and exterior detail from our Palisades Park base. From $220 interior / $275 full. Book online.',
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Exterior Detail & Paint Enhancement (from $370) is the exterior-only path for film, pollen, and decontamination. Add Premium Full Detail when the interior needs shampoo and steam too.',
      },
      {
    ...
    paragraphs: [
      'Englewood (07631) is a short run north of Palisades Park. Cardetail1 details in residential driveways along the tree-lined streets and in approved lots — we bring water and power, and we price from the same Bergen County catalog: Interior Detail from $200 Premium Full Detail from $250 for sedans (SUVs from $300), Exterior Detail & Paint Enhancement from $335.',
      ...
      'What Interior Detail includes in Englewood is identical to Palisades Park: seats, carpets, trunk, steam, UV on plastics. Premium Full Detail adds the exterior wash and clay. Exterior Detail from $370 is clay, polish, sealant, Rain-X, and wheels. Wet weather pauses exterior work; we do not pretend a detail can be finished in a downpour. Hours Monday–Friday 8AM–5PM. Request with ZIP 07631; no payment at submission.',
      'Call (551) 389-3986 for gates and HOA questions. Nearby: Palisades Park, Fort Lee, Teaneck, Hackensack. Tenafly and Alpine remain on the Bergen County hub list until they have their own pages — enter those ZIPs on the homepage if that is where the car is.',
    ],
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Premium Full Detail — inside and out — is marked most booked on the homepage. SUVs from $300, 3-row from $310.',
      },
    ],
    paragraphs: [
      'Teaneck (07666) sits between Englewood and Hackensack, still on the Palisades Park core route. We detail in suburban driveways with our own water and power. Prices are the live catalog: Interior Detail from $200 sedan / $245 two-row SUV, Premium Full Detail from $275 / $300 / $310, Exterior Detail from $370.',
  ...
  },
  {
    ...
    description:
      'Mobile car detailing in Ridgewood, NJ (07450). Interior from $200, full detail from $250 at your driveway. Bergen County route from Palisades Park. Book online.',
    ...
    paragraphs: [
      ...
      'Interior Detail includes seats, carpets, trunk, steam, and interior glass. Premium Full Detail adds wash, clay, and sealant. Exterior Detail from $370 includes single-pass paint enhancement and Rain-X. Add-ons (pet hair, odor, polymer, 1-year wax) are the same dollars as Palisades Park. We do not invent a Ridgewood travel surcharge on standard core pricing — enter the ZIP so the form can show the live total.',
      'Submit ZIP 07450 or call (551) 389-3986. Nearby dedicated pages: Paramus, Hackensack, Teaneck, Palisades Park. Glen Rock and Fair Lawn stay on the New Jersey hub accordion for now; those links still work as in-county anchors until they get their own files. Request first, pay after service — same as every other Bergen page.',
    ],
  },
  {
    ...
    paragraphs: [
      ...
      'Book with ZIP 07020 or call (551) 389-3986 for garage questions. Nearby: Fort Lee, Palisades Park, Englewood, Hackensack, Teaneck. Cliffside Park and Fairview remain on the county hub city list; use those ZIPs on the homepage if that is where the vehicle will sit. Public quotes lower on this page are shown as written.',
    ],
  },
];
...
<nav class="nav" id="main-nav">
  ...
  <div class="nav-links" id="nav-links">
    ...
    <a class="nav-link" href="tel:+15513893986">Call / Text</a>
...
<header class="sp-hero">
  ...
  <div class="sp-btns">
    ...
    <a class="sp-btn sp-btn-outline" href="tel:+15513893986">Call (551) 389-3986</a>
  </div>
</header>
...
<section class="sp-cta" aria-label="Book in ${city.city}">
  ...
  <div class="sp-btns">
    ...
    <a class="sp-btn sp-btn-outline" href="tel:+15513893986">Call / Text</a>
  </div>
</section>
<footer class="specialty-public-footer" id="cd1-public-footer">
  <div class="foot-in">
    <div class="foot-top">
      ...
      <div class="foot-col">
        <h4>Contact</h4>
        <a href="tel:+15513893986">Call / Text</a>
