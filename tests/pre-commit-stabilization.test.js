...
test('Netlify Function changes vs production master are limited to approved RevOps additions', () => {
  ...
  const allowed = new Set([
    ...
    'netlify/lib/owner-studio/customer-lifecycle-repository.js',
    ...
    // Customer Lifecycle — portal add-ons, eligibility, appointment dates/timeline
    'netlify/lib/customer-lifecycle/addon-error-map.js',
    'netlify/lib/customer-lifecycle/addon-compatibility.js',
    'netlify/lib/customer-lifecycle/appointment-dates.js',
    'netlify/lib/customer-lifecycle/appointment-timeline.js',
    'netlify/lib/customer-lifecycle/completed-service-history.js',
    'netlify/lib/customer-lifecycle/maintenance-eligibility.js',
    'netlify/lib/customer-lifecycle/membership-foundation.js',
